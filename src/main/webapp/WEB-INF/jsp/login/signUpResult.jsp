...
div#mid_left_img {
	width: 370px;
	height: 100%;
	background-image: url("/resources/image/sign_success.png");
	float: left;
}
			...
			<div class="panel panel-default" style="width: 80%;">
				<div class="panel-heading">
					<div id="top_title1">
						...
						<div class="top_title2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이메일
							인증을 통한 회원가입이 완료되었습니다.</div>
					</div>
				...
				<div id="step02_total">
					...
					<div id="mid_layout">
						<div id="mid_left_img"></div>

						<div id="mid_right">
							<label id="1">회원 가입을 환영합니다!</label><br>
							<br> <label id="2">회원님의 ID 는 <span id="email_link">${vo.user_email }</span>
								입니다.

							</label>

							<div id="okBtn">로그인 하러가기</div>
